...
import { Download, Smartphone, Shield, Zap, ArrowRight, Edit, Archive, BookOpen, Filter } from 'lucide-react';
          ...
          <div className="grid md:grid-cols-4 gap-8">
            ...
            <div>
              ...
              <ul className="space-y-2 text-gray-400">
                <li>
                  <button onClick={scrollToTop} className="hover:text-amber-500 transition-colors">
                    Accueil
                  </button>
                </li>
                <li>
                  <button onClick={scrollToFeatures} className="hover:text-amber-500 transition-colors">
                    Fonctionnalités
                  </button>
                </li>
                <li>
                  <button onClick={() => setShowContactForm(true)} className="hover:text-amber-500 transition-colors">
                    Contact
                  </button>
                </li>
              </ul>
            ...
            <div>
              <h4 className="font-semibold mb-4 cursor-pointer" onClick={() => setShowContactForm(true)}>Contact</h4>
              <ul className="space-y-2 text-gray-400">
